...
public class ControlPanel {
    ...
    public void refreshTimeStatus() {
        ...
        lblClock.setText(String.format("Time: %02d", core.TimeSystem.hour));
    ...
    void onSeasonJumpClicked(ActionEvent event) {
        try {
            refreshTimeStatus();
            System.out.println("🕒 Season jump executed: " + core.TimeSystem.season + " " + core.TimeSystem.day + " " + core.TimeSystem.hour);
        } catch (Exception e) {
