...
public class MapController {
    ...
    private String buildSelectedAnimalInfo() {
        ...
        info.append("Hunger: ").append(String.format("%.1f", selectedAnimal.getHungerPercentage())).append("\n");
        info.append("Thirst: ").append(String.format("%.1f", selectedAnimal.getThirstPercentage())).append("\n");
                ...
                for (int cx = 0; cx < worldMap.chunkMap[cy].length; cx++) {
                    ...
                    for (entities.base.Entity entity : safeEntities) {
                        ...
                        if (entity instanceof entities.base.Animals animal) {
                            ...
                            int stage = 1;
                            if (entity instanceof entities.base.Plant tree) {
